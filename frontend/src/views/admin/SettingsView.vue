      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6">
        ...
        <div class="card">
          ...
          <div class="space-y-6 p-6">
            ...
            <div class="flex items-center justify-between py-3">
              <div>
                <label class="input-label">{{ t('admin.settings.models.enabled') }}</label>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('admin.settings.models.enabledHint') }}</p>
              </div>
              <Toggle v-model="form.models_enabled" />
            </div>
          </div>
        </div>
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      models_enabled: form.models_enabled,
