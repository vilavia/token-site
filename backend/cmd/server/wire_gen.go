...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	epayClient := service.NewEpayClient(configConfig)
	paymentService := service.NewPaymentService(configConfig, epayClient, client, userRepository, settingService)
	adminPaymentHandler := admin.NewAdminPaymentHandler(paymentService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, adminAPIKeyHandler, scheduledTestHandler, adminPaymentHandler)
	...
	chatService := service.NewChatService(gatewayService, apiKeyService, billingService)
	...
	modelCatalogService := service.NewModelCatalogService(gatewayService, billingService, groupRepository)
	modelCatalogHandler := handler.NewModelCatalogHandler(modelCatalogService)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, soraGatewayHandler, soraClientHandler, handlerSettingHandler, totpHandler, idempotencyCoordinator, idempotencyCleanupService, paymentHandler, chatHandler, chatHistoryHandler, modelCatalogHandler)
